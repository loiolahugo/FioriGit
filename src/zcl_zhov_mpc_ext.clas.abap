class ZCL_ZHOV_MPC_EXT definition
  public
  inheriting from ZCL_ZHOV_MPC
  create public .
...
CLASS ZCL_ZHOV_MPC_EXT IMPLEMENTATION.
...
method DEFINE.
  ...
  lo_entity_type->bind_structure( iv_structure_name = 'ZCL_ZHOV_MPC_EXT=>TY_ORDEM_ITEM' ).
endmethod.
ENDCLASS.
