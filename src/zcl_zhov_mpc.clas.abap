...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZHOV_MPC===================CP' ##NO_TEXT.
...
CLASS ZCL_ZHOV_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHOV_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZHOV_MPC=>TS_MENSAGEM' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZHOV_MPC=>TS_OVCAB' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZHOV_MPC=>TS_OVITEM' ). "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZHOV_MPC=>TS_ZFI_ATUALIZA_STATUS' ). "#EC NOTEXT
  endmethod.
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_complex_type->bind_structure( iv_structure_name = 'ZCL_ZHOV_MPC=>MENSAGEM2' ). "#EC NOTEXT
  endmethod.
ENDCLASS.
