class ZCL_ZHOV_DPC_EXT definition
  public
  inheriting from ZCL_ZHOV_DPC
  create public .
...
endmethod.
  ...
  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~EXECUTE_ACTION.
    DATA: ld_ordemid  TYPE ZHOVcab-ordemid.
      DATA: ld_status   TYPE ZHOVcab-status.
      DATA: lt_bapiret2 TYPE STANDARD TABLE OF zcl_zhov_mpc_ext=>mensagem2.
      DATA: ls_bapiret2 TYPE zcl_zhov_mpc_ext=>mensagem2.
